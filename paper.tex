...
2.2 LiDAR-Based Perception ............................................................................................ 4

2.3 Multi-Sensor Fusion ................................................................................................... 5

2.4 GPU-Accelerated Vision Processing .......................................................................... 5

2.5 Deep Learning–Based Object Detection ..................................................................... 6

2.6 Distributed Perception Using ROS 2 .......................................................................... 6

2.7 Overall System Pipeline and Flow .............................................................................. 7

2.8 ROS Parameters and Configuration ........................................................................... 8

2.9 System Inputs and Outputs ........................................................................................ 8

2.10 Summary .................................................................................................................. 9

2.11 ROS 2 Nodes, Topics, and Data Flow ...................................................................... 9

2.12 Configuration Files and CSV Usage ....................................................................... 13

2.13 End-to-End Data Flow Summary ............................................................................ 13

Chapter 3: LiDAR Perception Pipeline ........................................................................... 14 * 3.1 Overview .................................................................................................................. 14

3.2 LiDAR Sensor and System Configuration ................................................................. 14

3.2.1 RoboSense RS16 LiDAR .................................................................................. 14

3.3 LiDAR Data Acquisition ............................................................................................ 15

3.3.1 LiDAR Driver Node .......................................................................................... 15

3.3.2 Coordinate Transformation .............................................................................. 15

3.4 LiDAR Preprocessing ............................................................................................... 16

3.5 Background Subtraction ........................................................................................... 17

3.5.1 Background Subtraction Node ........................................................................ 17

3.5.2 Background Modeling Algorithm ..................................................................... 17

3.6 LiDAR Clustering ...................................................................................................... 18

3.6.1 Clustering Node .............................................................................................. 18

3.6.2 Euclidean Clustering Algorithm ........................................................................ 18

3.7 LiDAR Object Representation ................................................................................... 19

3.8 Operational Workflow ............................................................................................... 19

3.9 Advantages of the LiDAR Pipeline ............................................................................ 20

3.10 Summary ................................................................................................................ 20

Chapter 4: Camera Perception and Time Synchronization Pipeline ............................. 21 * 4.1 Axis Camera System Overview ................................................................................ 21

4.2 Camera Data Acquisition .......................................................................................... 21

4.3 Camera Image Transport and Processing ................................................................ 22

4.4 Camera Time Synchronization .................................................................................. 23

4.4.1 LiDAR Time Reference (GPS Time) ................................................................ 23

4.4.2 Camera Time Alignment Strategy ................................................................... 23

4.4.3 Precision Time Protocol (PTP) Integration ...................................................... 23

4.5 Camera Image Undistortion (NVIDIA VPI-Based) ..................................................... 25

4.5.1 Lens Distortion Model ...................................................................................... 25

4.5.2 GPU-Accelerated Undistortion ......................................................................... 26

4.6 Deep Learning–Based Object Detection ................................................................... 28

4.7 Camera Intrinsic Calibration ..................................................................................... 28

4.7.1 Intrinsic Parameters and Projection Model ....................................................... 28

4.8 Camera–LiDAR Extrinsic Calibration ........................................................................ 32

4.8.1 Coordinate Frame Alignment .......................................................................... 32

4.9 2D–3D Projection and Camera–LiDAR Association ................................................. 35

4.10 Camera-Based Object Tracking ............................................................................. 38

4.10.1 Tracking Objectives ...................................................................................... 38

4.10.2 Kalman Filter Model ...................................................................................... 39

Chapter 5: Global Tracking and Multi-Sensor Fusion ................................................... 44 * 5.1 Motivation for Global Fusion ..................................................................................... 44

5.2 Camera Track Aggregation ...................................................................................... 44

5.3 LiDAR–Camera Track Association ........................................................................... 46

5.4 Global Fusion Processing Flow ................................................................................ 47
...
Clustering to segment foreground points into object-level representations
...
Mid-level fusion: Combining learned features

Late (object-level) fusion: Combining detection outputs
...
2.4 GPU-Accelerated Vision Processing
...
A YOLO model is trained offline using camera data collected from the mobile mast setup

The trained model (best.pt) is converted to a TensorRT engine for optimized inference on Jetson Orin

The detector outputs 2D bounding boxes, class labels, and confidence scores in rectified image coordinates

These detections serve as the semantic input to the 2D–3D fusion pipeline.

2.6 Distributed Perception Using ROS 2
...
Use of a common ROS 2 domain ID

Time synchronization using Chrony

Consistent TF frame management

Separation of computational load across devices

This distributed approach improves scalability, fault isolation, and real-time performance.

2.7 Overall System Pipeline and Flow

Figure 2.1 illustrates the complete perception pipeline deployed across the three Orin devices.

Orin 1 – Sensor Drivers and Preprocessing

Axis cameras stream video via HTTP/RTSP

axis\_camera\_ros publishes compressed image topics

Image republishing converts streams into raw image topics

LiDAR driver publishes raw point clouds

LiDAR preprocessing and background subtraction isolate foreground points

LiDAR clustering extracts object-level point clusters

Orin 2 – Perception and 2D–3D Association

NVIDIA VPI–based undistortion nodes rectify camera images

YOLO detection nodes perform object detection on rectified images

Camera-to-3D projection nodes associate 2D detections with LiDAR data

3D detections are published for each camera stream

Orin 3 – Tracking and Global Fusion

Camera-specific trackers maintain object identities over time

A global fusion node merges tracks from multiple cameras and LiDAR

Visualization nodes publish RViz markers for monitoring and analysis

2.8 ROS Parameters and Configuration

The system relies on ROS 2 parameters for flexible configuration, including:

Camera intrinsic and distortion parameters

VPI backend selection (CUDA or VIC)

YOLO inference thresholds

LiDAR clustering distances
...
2.9 System Inputs and Outputs

Inputs

Camera image streams (/image\_raw)

LiDAR point clouds (/lidar/points)

Camera calibration data (CameraInfo)

Configuration parameters

Outputs

Rectified images (/image\_rect)
...
Rosbag recordings for offline analysis
...
2.11 ROS 2 Nodes, Topics, and Data Flow
...
Orin 1 – Sensor Drivers and Preprocessing Nodes

axis\_camera\_ros

Function: Captures live video streams from Axis network cameras using HTTP/RTSP.

Inputs:

Network camera stream (RTSP/HTTP)

Publishes:

/mast/orin1/bulletX/image\_raw/compressed
...
Resolution(Configured via ROS parameters in the launch file)

This node acts as the entry point of visual data into the system.

image\_transport / republish

Function: Converts compressed camera streams into raw image messages for downstream processing.
...
/mast/orin1/bulletX/image\_raw

Purpose:

Ensures compatibility with image processing and VPI nodes

rslidar\_sdk\_node

Function: Interfaces with the RoboSense RS16 LiDAR sensor.

Inputs:

Raw LiDAR packets from sensor
...
Calibration parameters (via YAML/CSV)

rslidar\_preprocess

Function: Filters raw LiDAR point clouds.
...
/mast/orin1/lidar/points\_filtered
...
lidar\_background\_subtraction

Function: Separates static background from dynamic foreground points.
...
Background model thresholds

Temporal accumulation parameters

lidar\_cluster\_node

Function: Groups foreground points into object clusters.
...
Orin 2 – Vision Perception and 2D–3D Association Nodes

vpi\_undistort\_node

Function: Corrects lens distortion using NVIDIA VPI.
...
/mast/orin1/bulletX/image\_rect

Uses:

Camera calibration file (YAML/CSV)
...
VPI backend (CUDA / VIC)

This node ensures all downstream detections occur in a rectified pixel coordinate system.

yolo\_detector\_node

Function: Performs object detection on rectified images.
...
/mast/orin1/bulletX/detections\_2d

Model Files:

best.pt (training)

best.engine (TensorRT inference)
...
camera\_image\_to\_3d

Function: Projects 2D detections into 3D space.
...
/mast/orin1/bulletX/detections\_3d

Uses CSV / Config Files:

Camera–LiDAR extrinsic calibration

Transformation matrices

Orin 3 – Tracking, Fusion, and Visualization Nodes

camera\_tracker\_node

Function: Tracks detected objects over time using camera-based 3D detections.
...
Track initiation and termination thresholds

global\_fusion\_node

Function: Performs multi-sensor fusion by combining camera-based tracks with LiDAR-based object clusters to produce globally consistent 3D object tracks.

Subscribes:

/mast/orin1/bulletX/tracks\_3d (camera tracks)

/mast/orin1/lidar/clusters (LiDAR object clusters)

Publishes:

/mast/global/tracks\_3d

Fusion Logic:

Spatial proximity in 3D space

Temporal consistency across frames

Track confidence and sensor reliability weighting

LiDAR-based position refinement

tracks\_to\_markers\_node

Function: Converts fused global tracks into visualization markers.
...
/mast/global/tracks\_markers

Output:

RViz-compatible markers for real-time visualization and debugging

2.12 Configuration Files and CSV Usage
...
2.13 End-to-End Data Flow Summary

Sensors generate raw camera images and LiDAR point clouds

Data is preprocessed and filtered on Orin 1

Images are undistorted and objects detected on Orin 2

2D detections are projected into 3D space

Objects are tracked and fused on Orin 3

Results are visualized in RViz and recorded using rosbag

Chapter 3: LiDAR Perception Pipeline
...
3.2 LiDAR Sensor and System Configuration

3.2.1 RoboSense RS16 LiDAR
...
LiDAR IP address: 192.168.6.60

Communication protocol: UDP

Output data: Raw LiDAR packets containing range, intensity, and angle measurements
...
Raw LiDAR packets streamed from the sensor

Outputs:

/mast/orin1/lidar/points (sensor\_msgs/PointCloud2)

Supporting Configuration Files:

Sensor model YAML file

Angle and channel calibration CSV files

Network configuration parameters (IP, port)
...
rrr is the measured distance

θ\textbackslash\{\}thetaθ is the azimuth angle

ϕ\textbackslash\{\}phiϕ is the vertical elevation angle

These Cartesian coordinates form the raw point cloud representation.

3.4 LiDAR Preprocessing

3.4.1 Preprocessing Node
...
3.4.2 Filtering Operations

The preprocessing stage applies the following operations:

Range Filtering Removes points that lie outside a predefined minimum and maximum distance range.

Ground Removal Eliminates ground points using height-based thresholds relative to the sensor frame.

Noise Suppression Removes isolated points with insufficient local neighborhood density.
...
3.5.1 Background Subtraction Node
...
3.5.2 Background Modeling Algorithm
...
δ\textbackslash\{\}deltaδ is the spatial stability threshold

NNN is the temporal accumulation window

Points violating this condition are classified as dynamic foreground points.

Supporting Configuration Files:

CSV/YAML files specifying:

Temporal window size

Distance threshold δ\textbackslash\{\}deltaδ

Background confidence decay rate

3.6 LiDAR Clustering

3.6.1 Clustering Node
...
Distance threshold ϵ\textbackslash\{\}epsilonϵ

Minimum cluster size

Maximum cluster size

3.7 LiDAR Object Representation
...
Raw LiDAR packets are received from the RS16 sensor.

The driver decodes packets and publishes raw point clouds.

Preprocessing filters remove noise and irrelevant points.

Background subtraction isolates dynamic foreground objects.

Clustering groups foreground points into object-level clusters.

Cluster outputs are published for tracking, fusion, and visualization.

This progressive refinement ensures robust and real-time LiDAR perception.

3.9 Advantages of the LiDAR Pipeline

Robust to lighting conditions

Accurate 3D spatial measurements

Modular and scalable ROS 2 design

Real-time performance on embedded hardware

Clean object-level outputs for higher-level processing
...
Chapter 4: Camera Perception Pipeline

Chapter 4

Camera Perception and Time Synchronization Pipeline**

4.1 Axis Camera System Overview
...
4.2 Camera Data Acquisition

4.2.1 Axis Camera Hardware
...
Compressed images: Iccomp(t)I\_c\^{}\{comp\}(t)Iccomp​(t)

Raw images: Icraw(t)I\_c\^{}\{raw\}(t)Icraw​(t)
...
4.3 Camera Image Transport and Processing

4.3.1 Compressed Image Transport
...
4.4.2 Camera Time Alignment Strategy
...
4.4.3 Precision Time Protocol (PTP) Integration
...
(xu,yu)(x\_u, y\_u)(xu​,yu​): undistorted coordinates

(xd,yd)(x\_d, y\_d)(xd​,yd​): distorted coordinates

4.5.2 GPU-Accelerated Undistortion
...
4.6 Operational Workflow: How the Camera Pipeline Works

Axis cameras capture images and stream them over RTSP.

axis\_camera\_ros publishes compressed image topics.

Images are decoded and republished as raw images.

Camera clocks are synchronized to LiDAR time using PTP.

Timestamps are aligned to the GPS-based reference.

Distorted images are undistorted using GPU acceleration.

Rectified images are forwarded to downstream perception modules.

This sequential processing ensures geometrically and temporally consistent camera data.

4.7 Advantages of the Camera Pipeline

High-resolution semantic information

Precise temporal alignment with LiDAR

GPU-accelerated image processing

Scalable multi-camera support

Robustness to clock drift
...
4.5 NVIDIA VPI–Based Image Undistortion
...
(ur,vr)(u\_r, v\_r)(ur​,vr​) are pixel coordinates in the rectified image

(ud,vd)(u\_d, v\_d)(ud​,vd​) are corresponding coordinates in the original distorted image

KKK is the camera intrinsic matrix

DDD is the vector of distortion coefficients
...
4.5.3 Rectified Image Topics

Once the WarpMap is generated, incoming camera frames are processed as follows:

The distorted image IdI\_dId​ is received from the camera pipeline.

The WarpMap is applied using GPU acceleration to compute the rectified image: Ir(ur,vr)=Id(f(ur,vr))I\_r(u\_r, v\_r) = I\_d(f(u\_r, v\_r))Ir​(ur​,vr​)=Id​(f(ur​,vr​))

The output image IrI\_rIr​ has corrected geometry, where straight lines in the real world appear straight in the image plane.
...
Why NVIDIA VPI Is Used

The choice of NVIDIA VPI provides several advantages:

GPU-accelerated remapping using CUDA or VIC backends

Low-latency real-time performance on Jetson Orin

Reduced CPU load for other perception tasks

Consistent geometric correction across all camera streams
...
Operational Workflow: How the Undistortion Pipeline Works

Camera calibration parameters are received via CameraInfo.

VPI computes a WarpMap using the lens distortion model.

Each incoming distorted image is remapped using the WarpMap.

Rectified images are published with preserved timestamps.

Downstream nodes operate on geometrically corrected images.
...
4.6 Deep Learning–Based Object Detection - FATIK

4.6.1 YOLOv11 Architecture

4.6.2 Model Training and Dataset Preparation

4.6.3 TensorRT Engine Deployment

4.7 Camera Intrinsic Calibration
...
fx,fyf\_x, f\_yfx​,fy​: focal lengths in pixel units

cx,cyc\_x, c\_ycx​,cy​: principal point coordinates
...
Xi\textbackslash\{\}mathbf\{X\}\_iXi​ are known 3D points

ui\textbackslash\{\}mathbf\{u\}\_iui​ are observed image points

π(⋅)\textbackslash\{\}pi(\textbackslash\{\}cdot)π(⋅) is the camera projection function

Usage in the Project

In this project:

Intrinsic parameters are loaded from calibration files

Parameters are published via ROS CameraInfo messages

All downstream nodes assume a rectified pinhole camera model

4.7.2 Distortion Coefficients
...
4.7.3 Integration into the Perception Pipeline

ROS Nodes and Topics

CameraInfo Publisher

Publishes intrinsic matrix KKK and distortion vector DDD

Topics:

/mast/orin1/bulletX/camera\_info

Consumers of Calibration Data:

VPI undistortion node

2D–3D projection nodes

Visualization modules

How It Works in the Project

Camera calibration parameters are loaded from configuration files.

Intrinsic parameters and distortion coefficients are published via CameraInfo.

The undistortion node subscribes to CameraInfo and generates a WarpMap.

Rectified images are produced using GPU acceleration.

Downstream perception nodes assume an ideal pinhole camera model.

This ensures that all geometric computations operate in a consistent and physically meaningful coordinate system.

4.7.4 Output and Impact

Accurate intrinsic calibration enables:

Correct pixel-to-ray back-projection

Precise 2D–3D association

Reduced reprojection error

Improved tracking and fusion accuracy
...
4.8 Camera–LiDAR Extrinsic Calibration
...
4.8.1 Coordinate Frame Alignment

Sensor Coordinate Frames

Each sensor operates in its own coordinate frame:

LiDAR frame (FL\textbackslash\{\}mathcal\{F\}\_LFL​) Origin at the LiDAR sensor, axes defined by the sensor manufacturer.

Camera frame (FC\textbackslash\{\}mathcal\{F\}\_CFC​) Origin at the camera optical center, with the optical axis aligned along the ZZZ-axis.
...
R∈SO(3)\textbackslash\{\}mathbf\{R\} \textbackslash\{\}in SO(3)R∈SO(3) is the rotation matrix

t∈R3\textbackslash\{\}mathbf\{t\} \textbackslash\{\}in \textbackslash\{\}mathbb\{R\}\^{}3t∈R3 is the translation vector
...
4.8.2 Extrinsic Transformation Estimation
...
Translation (x,y,z)(x, y, z)(x,y,z)

Rotation (roll,pitch,yaw)(roll, pitch, yaw)(roll,pitch,yaw)

These parameters are loaded at runtime by perception and projection nodes.

4.8.3 Integration into the Project Pipeline

ROS Nodes and Topics

Extrinsic Transformation Publisher

Publishes static transforms using tf\_static
...
Camera–LiDAR association nodes

Visualization modules (RViz)

How It Works in the System

Extrinsic calibration parameters are loaded from configuration files.

A static transform between the LiDAR and camera frames is published.

LiDAR points are transformed into the camera frame.

Transformed points are projected onto the image plane.

Camera detections are associated with LiDAR geometry.

This process ensures consistent spatial alignment across sensors.

4.8.4 Impact on Multi-Sensor Fusion

Accurate extrinsic calibration enables:

Correct projection of LiDAR points into camera images

Reliable 2D–3D object association

Stable tracking and fusion across sensors

Meaningful visualization in RViz
...
4.9 2D–3D Projection and Camera–LiDAR Association
...
4.9.1 Motivation for 2D–3D Projection
...
Semantic information from cameras

Metric depth and position from LiDAR

This fusion enables accurate 3D object localization and tracking.

4.9.2 Mathematical Formulation of 3D-to-2D Projection

LiDAR Point Transformation
...
RCL\textbackslash\{\}mathbf\{R\}\_\{CL\}RCL​ is the rotation matrix

tCL\textbackslash\{\}mathbf\{t\}\_\{CL\}tCL​ is the translation vector
...
(u,v)(u, v)(u,v) are pixel coordinates

ZC>0Z\_C > 0ZC​>0 ensures the point lies in front of the camera

Only points that project within image boundaries are considered valid.

4.9.3 Camera–LiDAR Association Algorithm
...
4.9.4 Node Implementation in the Project

Projection and Association Node

Function: Associates camera detections with LiDAR clusters and computes 3D object positions.

Subscribes:

2D detections (pixel bounding boxes)

LiDAR clusters or raw projected points

TF transforms (/tf, /tf\_static)

Publishes:

3D detections per camera:
...
4.9.5 How the Projection Pipeline Works in Practice

LiDAR clusters are transformed into the camera frame.

Each LiDAR point is projected onto the image plane.

Camera detections define regions of interest in pixel space.

LiDAR points falling inside each bounding box are selected.

Object depth and position are computed.

3D detections are published for tracking.

This process is executed in real time for each camera stream.

4.9.6 Advantages of Object-Level Association

The object-level projection approach provides:

Modular sensor independence

Reduced computational complexity

Robustness to partial occlusions

Clear separation between detection and fusion

It also allows easy extension to additional cameras or sensors.

4.9.7 ROS Topics and Data Flow Summary
...
4.10 Camera-Based Object Tracking
...
Estimate object position and velocity in 3D space

Handle temporary detection loss (occlusions)

Suppress false detections and measurement noise

Provide stable inputs to global fusion and visualization

Tracking is performed per camera stream before global fusion.

4.10.2 Kalman Filter Model
...
(x,y,z)(x, y, z)(x,y,z) is the 3D position

(x˙,y˙,z˙)(\textbackslash\{\}dot\{x\}, \textbackslash\{\}dot\{y\}, \textbackslash\{\}dot\{z\})(x˙,y˙​,z˙) is velocity

(x¨,y¨,z¨)(\textbackslash\{\}ddot\{x\}, \textbackslash\{\}ddot\{y\}, \textbackslash\{\}ddot\{z\})(x¨,y¨​,z¨) is acceleration
...
4.10.3 Track Initialization and Termination

Track Initialization

A new track is initialized when:

A 3D detection cannot be associated with an existing track

The detection persists for a minimum number of frames
...
Multi-Tracking Hypothesis Management

The system supports multiple hypotheses by:

Allowing tracks to persist without measurements for a limited time

Maintaining track confidence scores

Delaying track deletion until confidence falls below a threshold
...
They remain unmatched beyond a timeout threshold

Covariance exceeds uncertainty limits

Confidence score drops below minimum

4.10.4 Tracking Workflow (Processing Flow)
...
Step 1: State Prediction Using Motion Model
...
F\textbackslash\{\}mathbf\{F\}F is the state transition matrix

Q\textbackslash\{\}mathbf\{Q\}Q is the process noise covariance
...
Step 2: Reception of New 3D Measurements
...
Step 3: Cost Matrix Computation
...
Step 4: Hungarian Assignment Optimization
...
The detection persists across consecutive frames

The detection confidence exceeds a threshold

Initial state values for velocity and acceleration are set to zero with large covariance to reflect uncertainty.

Step 7: Track Aging and Termination
...
Missed detections exceed a timeout limit

Covariance exceeds stability bounds

Track confidence falls below minimum threshold

This prevents ghost tracks and false positives.

Step 8: Publishing Updated Track States
...
4.10.6 ROS Node Integration

Node: camera\_tracker\_node
...
Chapter 5: Global Tracking and Multi-Sensor Fusion

5.1 Motivation for Global Fusion
...
The same physical object may be detected by multiple cameras

Individual camera tracks may be noisy or temporarily lost

LiDAR-only clusters lack semantic labels

Camera-only tracks lack robust depth estimates

Global fusion addresses these challenges by:

Merging redundant tracks from different sensors

Reinforcing weak tracks using complementary modalities

Producing a consistent, globally referenced object list

Enabling reliable visualization and downstream decision-making
...
5.2 Camera Track Aggregation

5.2.1 Input Track Representation
...
5.2.3 Inter-Camera Track Similarity
...
5.2.4 Track Aggregation Logic

When multiple tracks satisfy spatial and temporal consistency:

A single global track is created

Position is estimated using weighted averaging

Velocity is combined similarly
...
5.3 LiDAR–Camera Track Association

5.3.1 Role of LiDAR in Global Fusion
...
5.3.2 LiDAR Cluster Representation
...
5.3.3 Camera–LiDAR Association Metric
...
5.3.4 Fusion of Camera and LiDAR Tracks

When association is successful:

Camera track provides semantic label

LiDAR cluster refines position and size
...
5.3.5 Handling Unmatched Tracks

Camera-only tracks remain active but marked as low-confidence

LiDAR-only clusters are published without semantic labels

Tracks may later be fused when data becomes available
...
Step 1: Reception of Camera-Based Tracks
...
Tc\textbackslash\{\}mathcal\{T\}\_cTc​ denotes the set of tracks from camera ccc

Each track includes position, velocity, confidence, and timestamp
...
Step 2: Temporal Alignment of Tracks
...
ti,tjt\_i, t\_jti​,tj​ are the track timestamps

Δtfusion\textbackslash\{\}Delta t\_\{\textbackslash\{\}text\{fusion\}\}Δtfusion​ is a configurable temporal tolerance

This step is enabled by Chrony-based system time synchronization across Orin devices.

Step 3: Inter-Camera Track Association
...
Step 4: Merging Duplicate Camera Tracks
...
Step 6: Computation of Fused Object States
...
α\textbackslash\{\}alphaα is a tunable weight based on confidence and sensor reliability

This fusion improves depth accuracy while preserving semantic labels from the camera.

Step 7: Global Track Management

Global tracks are maintained across frames with:

Unique global track IDs

Track age and confidence counters

Motion consistency checks

Tracks are terminated if:

No association occurs for a defined duration

Confidence drops below a threshold

Covariance grows beyond limits

Step 8: Publishing Global Tracks
...
Summary of Global Fusion Flow

The global fusion workflow systematically:

Aligns multi-camera tracks temporally

Eliminates duplicate detections

Integrates LiDAR geometry

Produces stable, globally consistent object tracks
...
5.5 ROS Node Implementation

Node: global\_fusion\_node
...
Chapter 6: Visualization and System Monitoring
...
6.1 RViz Visualization Framework
...
Fused 3D object tracks

Bounding boxes and trajectories

Sensor coordinate frames

System state and timing consistency
...
Node: tracks\_to\_markers\_node
...
Orientation: derived from object motion direction

Scale: object dimensions

Color: class-dependent or confidence-based

Transparency: reflects track confidence

6.2.2 Track ID and Trajectory Visualization
...
6.3 Real-Time System Monitoring
...
Time-consistent transforms

Latency and Update Rate Monitoring
...
6.4 Visualization Data Flow Summary

Global fusion node publishes fused tracks

Marker generation node converts tracks into markers

RViz subscribes to marker topics

Objects, trajectories, and IDs are rendered in real time
...
Chapter 7: Time Synchronization and System Timing
...
7.1 Importance of Time Synchronization
...
Incorrect association between camera and LiDAR detections

Degraded tracking accuracy

Inconsistent TF transformations

Fusion instability during playback
...
7.2 Precision Time Protocol (PTP)
...
7.2.1 Camera Time Synchronization
...
Cameras operate as PTP slaves

The network clock acts as the grandmaster

Image acquisition timestamps are generated at the camera hardware level

This ensures that captured images are temporally consistent with LiDAR data and system clocks.

7.2.2 Network Time Alignment
...
Consistent timestamps across multiple cameras

Reduced temporal skew during high-bandwidth streaming

Improved accuracy in multi-camera fusion

7.3 Chrony-Based System Clock Synchronization

While PTP synchronizes sensors, Chrony is used to synchronize the system clocks of all computing devices.

7.3.1 Master–Client Configuration

The system is configured with:

Central PC as the Chrony master (NTP server)

Orin devices as Chrony clients
...
7.3.2 Verification and Drift Analysis
...
7.4 Timestamp Consistency in ROS 2
...
Sensor drivers assign timestamps at acquisition time

Processing nodes preserve original timestamps

Fusion nodes rely on header stamps for alignment

This design ensures temporal consistency across the entire processing pipeline.

7.4.2 TF Time Alignment
...
Consistent timestamps across transforms

Synchronization between TF and sensor data

Accurate extrapolation during lookup
...
7.5 End-to-End Timing Integrity

By combining:

PTP for sensor-level synchronization

Chrony for system-level synchronization

ROS 2 timestamp management
...
Chapter 8: Graphical User Interface (GUI) Architecture and System Control
...
Provide a single control interface for all Orin devices

Simplify node startup, shutdown, and verification

Enable real-time calibration and visualization

Integrate rosbag recording and playback

Reduce operational complexity during experiments and demonstrations

8.2 GUI Architecture Overview
...
SSH-based command execution for remote node control

ROS 2 subscriptions for live data visualization and calibration feedback

The GUI runs on a control workstation and connects to each Orin over a dedicated Ethernet network.

8.3 Process Control Interface

8.3.1 Multi-Orin Process Management

The Process Control tab organizes system components by Orin device:

Orin 1 (Sensors): LiDAR drivers, preprocessing, camera drivers

Orin 2 (Detection): VPI undistortion, YOLO detection, 2D–3D projection

Orin 3 (Tracking): Object tracking, global fusion, RViz marker publishing

Each Orin panel displays:

Device IP address

Remote access buttons (VNC and terminal)

Node-level Start, Stop, and Check controls

8.3.2 Node Control Mechanism

Each processing node is represented as a row with:

Start button: launches the node via SSH and shell scripts

Stop button: gracefully terminates the node

Check button: verifies node health by checking ROS topics or node names

This design ensures:

Independent control of each pipeline stage

Fault isolation between Orins

Rapid debugging and recovery

Figure 8.1: Orin 1 Tracking and Fusion Control

Figure 8.2: Orin 2 Sensor Control Panel

Figure 8.3: Orin 3 Tracking and Fusion Control

8.4 Calibration and Visualization Interface

8.4.1 Calibration View

The Calibration View tab provides a real-time visual interface for:

Camera–LiDAR spatial alignment
...
Figure 8.4: Calibration and Visualization Interface

8.5 Rosbag Recording and Playback
...
Automatic timestamp-based bag naming

Selection of relevant topics (camera, LiDAR, tracks, TF)

Playback Support

Load and replay recorded bags

Switch between live feed and offline playback

This enables reproducible experiments and efficient dataset generation.

8.6 Camera Lens Control and Spatial Alignment

8.6.1 VAPIX Lens Control
...
8.6.2 Spatial Alignment Controls
...
8.7 System Monitoring and Feedback
...
8.8 End-to-End System Workflow Using the GUI

Launch GUI on control workstation

Connect to all Orin devices

Start sensor drivers on Orin 1

Launch detection pipeline on Orin 2

Enable tracking and fusion on Orin 3

Verify outputs using RViz

Start rosbag recording

Stop and shut down nodes safely
